...
export const TRANSLATIONS = {
  en: {
    ...
    apiKeyHint: 'Enter your personal Gemini API key',
    apiKeyRequiredTitle: 'Personal API key required',
    apiKeyRequiredDesc: 'To generate AGENTS.md, first add your personal API key in Settings.',
    apiKeyGoToSettings: 'Go to Settings',
    apiKeyGuideButton: 'API Key Setup Guide',
    apiKeyGuideTitle: 'How to get your Gemini API key',
    apiKeyGuideStep1Title: 'Step 1: Open Google AI Studio',
    apiKeyGuideStep1Desc: 'Go to aistudio.google.com and sign in with your Google account.',
    apiKeyGuideStep2Title: 'Step 2: Create API Key',
    apiKeyGuideStep2Desc: 'From the API Keys section, click Create API key and copy the generated key.',
    apiKeyGuideStep3Title: 'Step 3: Save in this app',
    apiKeyGuideStep3Desc: 'Paste the key in Personal API Key field and click Save Settings.',
  ...
  fa: {
    ...
    language: 'زبان',
    settings: 'تنظیمات',
    apiKeyLabel: 'کلید API شخصی',
    apiKeyHint: 'کلید API شخصی Gemini خود را وارد کنید',
    apiKeyRequiredTitle: 'کلید API شخصی الزامی است',
    apiKeyRequiredDesc: 'برای ساخت AGENTS.md ابتدا باید کلید API شخصی خود را در تنظیمات وارد کنید.',
    apiKeyGoToSettings: 'رفتن به تنظیمات',
    apiKeyGuideButton: 'راهنمای دریافت کلید API',
    apiKeyGuideTitle: 'راهنمای دریافت کلید Gemini API',
    apiKeyGuideStep1Title: 'مرحله ۱: ورود به Google AI Studio',
    apiKeyGuideStep1Desc: 'به آدرس aistudio.google.com بروید و با حساب گوگل خود وارد شوید.',
    apiKeyGuideStep2Title: 'مرحله ۲: ساخت API Key',
    apiKeyGuideStep2Desc: 'در بخش API Keys روی Create API key بزنید و کلید ساخته‌شده را کپی کنید.',
    apiKeyGuideStep3Title: 'مرحله ۳: ذخیره در نرم‌افزار',
    apiKeyGuideStep3Desc: 'کلید را در فیلد کلید API شخصی وارد کرده و روی ذخیره تنظیمات بزنید.',
